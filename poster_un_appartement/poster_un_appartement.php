...
<div class="apart_accueil">
  ...
  <form class="" action="traitement_poster_appartement.php" method="post" enctype="multipart/form-data">
    ...
    <div>
      ...
      <input type="text" name="titre" id="titre" placeholder="Titre de votre annonce" value="" required autofocus>
    </div>
    <div>
    ...
    <div>
      ...
      <input type="number"  min="01000" max="97680" name="code_postal" id="code_postal" placeholder="Code postal de votre logement" value="" required>
    </div>
    <div>
    ...
    <div>
      ...
      <input type="number"  min="1" name="superficie" id="superficie" placeholder="Superficie de votre logement" value="" required>
    </div>
    <div>
